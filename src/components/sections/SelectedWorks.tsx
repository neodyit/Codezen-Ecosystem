...
const projects = [
  {
    ...
    stack: "2800+ Members / 60+ Core Team / Multiple WhatsApp Communities",
    description: "CodeZen is CGC University's student-led technology community built around technical excellence, leadership, innovation, and industry-ready skills.",
    imageSize: { width: "260px", height: "260px", radius: "32px" },
    links: { live: "#", code: "#" },
    image: "logo.png",
    cta: "View Details"
  },
  {
    ...
    stack: "Workshops / Bootcamps / Seminars / Competitions",
    description: "The community organizes workshops, bootcamps, seminars, competitions, networking events, and hands-on learning initiatives across technical and non-technical domains.",
    imageSize: { width: "100%", height: "280px", radius: "32px" },
    links: { live: "#", code: "#" },
    image: "",
    cta: "Explore Events"
  },
  {
    id: "003",
    title: "Hackathons & Registrations",
    stack: "50+ Events / 10000+ Event Registrations",
    description: "CodeZen supports hackathons and large-scale student participation, giving members practical spaces to build, collaborate, and present real-world work.",
    imageSize: { width: "100%", height: "320px", radius: "36px" },
    links: { live: "#", code: "#" },
    image: "./p3.png",
    cta: "View Details"
  },
  {
    id: "004",
    title: "Domain Teams",
    stack: "Technical / Management / Marketing / Design / Content / Media",
    description: "CodeZen brings students into multiple technical and non-technical domains, including programming, web development, cybersecurity, AI, cloud, marketing, design, media, and entrepreneurship.",
    imageSize: { width: "100%", height: "320px", radius: "36px" },
    links: { live: "#", code: "#" },
    image: "./p4.png",
    cta: "Meet Teams"
        ...
        {project.image ? (
          <img
            ...
            style={{
              ...
              maxWidth: "100%",
              maxHeight: "100%",
              borderRadius: project.imageSize.radius,
            }}
            onLoad={() => window.dispatchEvent(new Event('resize'))}
          />
        ) : (
          <div
            className="main-image flex items-center justify-center bg-white/5 text-white/40 text-xs font-bold uppercase tracking-[0.2em]"
            style={{
              width: project.imageSize.width,
              height: project.imageSize.height,
              maxWidth: "100%",
...
const SelectedWorks = () => {
  ...
  useLenis(({ scroll }) => {
    ...
    if (thread && threadLen > 0 && isMobile) {
      ...
      const animateText = (ref: RefObject<SVGTextElement | null>, targetP: number) => {
          ...
          <div className="marquee-selected-works__track">
            {[0, 1, 2, 3].map((blockIndex) => (
              <div key={blockIndex} className="marquee-selected-works__segment" aria-hidden={blockIndex > 0 ? "true" : undefined}>
                <span className="marquee-selected-works__text">CodeZen Milestones</span>
        ...
        {isMobile ? (
          <svg viewBox="0 0 1500 2000" className="w-full h-full" style={{ overflow: 'visible' }}>
            ...
            <g ref={figureGroupRef}>
              <text ref={textAnalyzeRef} x="750" y="150" fill="#ffffff" style={{ fontFamily: 'sans-serif', fontWeight: 800, fontSize: '100px', opacity: 0.3 }} textAnchor="middle" dy=".3em">BUILD</text>
              <circle cx="750" cy="250" r="15" fill="#ffffff" filter="url(#glow)" />

              <text ref={textDesignRef} x="250" y="700" fill="#ffffff" style={{ fontFamily: 'sans-serif', fontWeight: 800, fontSize: '100px', opacity: 0.3 }} textAnchor="middle" dy=".3em">DEVELOP</text>
              ...
              <text ref={textDeliverRef} x="750" y="1800" fill="#ffffff" style={{ fontFamily: 'sans-serif', fontWeight: 800, fontSize: '100px', opacity: 0.3 }} textAnchor="middle" dy=".3em">GROW</text>
          ...
          <svg viewBox="0 0 3000 1500" className="w-full h-auto" style={{ overflow: 'visible' }}>
            ...
            {[
              { text: 'BUILD', offset: '15%' }, { text: '•', offset: '27%' },
              { text: 'DEVELOP', offset: '38%' }, { text: '•', offset: '50%' },
              { text: 'LEAD', offset: '62%' }, { text: '•', offset: '73%' },
              { text: 'GROW', offset: '85%' },
            ].map((item, i) => (
